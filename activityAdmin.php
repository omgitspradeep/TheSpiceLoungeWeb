      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="activityAdmin.php">Staffs &nbsp;/&nbsp; Food Orders</a></li>
...
// Changing the status of food item based on its code 0,1,2,3 equals with waiting,cooking,Ready to serve and served.
                ...
                /* echo"<tr><td>"."--"."</td><td>".$itemFullName."</td><td>".$status."</td><td>".$row["tableNum"]."</td><td>".$row["quantity"]."</td><td>".$row["price"]."</td><td>".$row["prepareTime"]."</td><td>".$row["extraRequest"]."</tr>";
*/
                 echo"<tr>
                 <td>".$count."</td>
                 <td>".$itemFullName."</td>
